...
A-share exchange-traded ETFs use the separate `etf_short_swing_v1` contract: `sentiment_score` is a 1-5 trading-day opportunity score, not medium-term trend strength. Oversold and take-profit setups use symmetric 2-of-3 rules across RSI(12), MA5 bias, three-day return, and support/resistance. An oversold setup stays watch-only until price stabilizes and complete-day flow improves; starter size is 20%-30%, while an MA5 reclaim plus confirmed three-day inflow and positive five-day flow permits 40%-60%. The plan rejects structure stops beyond 3% or first resistance below 1.5R, takes half profit at first resistance/1.5R, exits fully on the complete take-profit rule, reduces when day 2 shows no progress, and exits/replans by day 5. Intraday active-flow estimates are display-only and never affect the score.
