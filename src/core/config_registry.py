...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "SEARXNG_PUBLIC_INSTANCES_ENABLED": {
        ...
        "description": "Auto-discover public SearXNG instances from searx.space when SEARXNG_BASE_URLS is empty. Disabled by default because public instances are not a trusted data source.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
