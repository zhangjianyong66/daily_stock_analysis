...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "VISION_MODEL": {
        "title": "Vision Model",
        "description": "Explicit LiteLLM route used for image understanding calls.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 5,
        "help_key": "settings.llm_channel.vision_model",
        "examples": [
    ...
    "VISION_API_MODE": {
        ...
        "description": "Protocol used by the shared Vision runtime.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "display_order": 5,
        "help_key": "settings.llm_channel.vision_api_mode",
        "examples": [
    ...
    "DATA_SOURCE_STOCK_NAME_TIMEOUT_SECONDS": {
        ...
        "description": "Caller-side timeout for each provider stock-name lookup. Set 0 to disable manager-level timeout.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 22,
        "help_key": "settings.data_source.DATA_SOURCE_STOCK_NAME_TIMEOUT_SECONDS",
        "examples": ["DATA_SOURCE_STOCK_NAME_TIMEOUT_SECONDS=8"],
        "docs": [
            {
                "label": "完整指南：数据源配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#数据源配置",
    ...
    "DATA_SOURCE_DAILY_TIMEOUT_SECONDS": {
        "title": "Daily Source Timeout",
        "description": "Caller-side timeout for each provider daily-data call. Set 0 to disable manager-level timeout.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 23,
        "help_key": "settings.data_source.DATA_SOURCE_DAILY_TIMEOUT_SECONDS",
        "examples": ["DATA_SOURCE_DAILY_TIMEOUT_SECONDS=45"],
        "docs": [
            {
                "label": "完整指南：数据源配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#数据源配置",
    ...
    "DATA_SOURCE_REALTIME_TIMEOUT_SECONDS": {
        ...
        "description": "Caller-side timeout for each provider realtime quote call. Set 0 to disable manager-level timeout.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0, "max": 300},
        "display_order": 24,
        "help_key": "settings.data_source.DATA_SOURCE_REALTIME_TIMEOUT_SECONDS",
        "examples": ["DATA_SOURCE_REALTIME_TIMEOUT_SECONDS=12"],
        "docs": [
            {
                "label": "完整指南：数据源配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#数据源配置",
    ...
    "SEARXNG_SECRET": {
        "title": "SearXNG Secret",
        "description": "Secret injected into the private Docker SearXNG service. Never commit a real value.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "validation": {},
        "display_order": 54,
        "help_key": "settings.data_source.search_cost_routing",
        "examples": ["SEARXNG_SECRET=generate-a-high-entropy-secret"],
        "docs": [
            {
                "label": "部署指南：私有 SearXNG",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/DEPLOY.md#私有-searxng-分层搜索",
            },
        ],
        "warning_codes": ["secret_value"],
    },
    "SEARCH_ROUTING_MODE": {
        "title": "Search Routing Mode",
        "description": "legacy preserves current provider behavior; searxng_first_cn routes A-shares and A-share ETFs through private SearXNG before Anspire.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            ...
            {"value": "searxng_first_cn", "label": "SearXNG first (CN)"},
        ],
        "validation": {},
        "display_order": 55,
        "help_key": "settings.data_source.search_cost_routing",
        "examples": ["SEARCH_ROUTING_MODE=legacy", "SEARCH_ROUTING_MODE=searxng_first_cn"],
        "docs": [
            {
                "label": "完整指南：搜索服务配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#搜索服务配置",
    ...
    "SEARXNG_REQUEST_TIMEOUT_SECONDS": {
        "title": "SearXNG Request Timeout",
        "description": "Hard timeout for one private SearXNG request in cost-routing mode.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 56,
        "help_key": "settings.data_source.search_cost_routing",
        "examples": ["SEARXNG_REQUEST_TIMEOUT_SECONDS=6"],
        "docs": [
            {
                "label": "完整指南：搜索服务配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#搜索服务配置",
    ...
    "SEARCH_INTEL_TOTAL_TIMEOUT_SECONDS": {
        "title": "Search Intel Total Timeout",
        "description": "Total low-cost intelligence-search budget for one stock; 0 disables the total deadline.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 57,
        "help_key": "settings.data_source.search_cost_routing",
        "examples": ["SEARCH_INTEL_TOTAL_TIMEOUT_SECONDS=30"],
        "docs": [
            {
                "label": "完整指南：搜索服务配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#搜索服务配置",
    ...
    "ANSPIRE_DAILY_WARNING_REQUESTS": {
        "title": "Anspire Daily Warning Requests",
        "description": "Beijing-day paid-request warning threshold in searxng_first_cn mode; 0 disables warning.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 58,
        "help_key": "settings.data_source.search_cost_routing",
        "examples": ["ANSPIRE_DAILY_WARNING_REQUESTS=30"],
        "docs": [
            {
                "label": "完整指南：搜索服务配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#搜索服务配置",
    ...
    "ANSPIRE_DAILY_HARD_LIMIT_REQUESTS": {
        "title": "Anspire Daily Hard Limit",
        "description": "Beijing-day paid-request hard limit in searxng_first_cn mode; 0 disables blocking.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 59,
        "help_key": "settings.data_source.search_cost_routing",
        "examples": ["ANSPIRE_DAILY_HARD_LIMIT_REQUESTS=50"],
        "docs": [
            {
                "label": "完整指南：搜索服务配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#搜索服务配置",
    ...
    "ANALYSIS_TASK_TIMEOUT_SECONDS": {
        "title": "Analysis Task Timeout Seconds",
        "description": "Maximum runtime for in-memory analysis/background tasks. Set 0 to disable queue-level timeout.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 51,
        "help_key": "settings.system.ANALYSIS_TASK_TIMEOUT_SECONDS",
        "examples": [
            "ANALYSIS_TASK_TIMEOUT_SECONDS=1200",
            "ANALYSIS_TASK_TIMEOUT_SECONDS=0",
        ],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
